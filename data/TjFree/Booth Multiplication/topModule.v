...
module top (input wire i0, i1, i2, output wire o);
   wire t;
   and2 and20 (i0, i1, t);
   and2 and21 (i2, t, o);
endmodule
...
module ntop (input wire i0, i1, i2, output wire o);
   wire t;
   and2 and20 (i0, i1, t);
   nand2 nand21 (i2, t, o);
endmodule
...
module fa (input wire i0, i1, cin, output wire sum, cout);
   wire t0, t1, t2;
   xor3 i0 (i0, i1, cin, sum);
   and2 i1 (i0, i1, t0);
   and2 i2 (i1, cin, t1);
   and2 i3 (cin, i0, t2);
   or3 i4 (t0, t1, t2, cout);
endmodule
...
module boothsubstep(input wire signed [7:0]a,Q,input wire signed q0,input wire signed [7:0] m,output reg signed [7:0] f8,output reg signed [7:0] l8,output reg cq0);
...
module boothmul(input signed[7:0]a,b,output signed [15:0] c);
	...
	boothsubstep step1(8'b00000000,a,1'b0,b,A1,Q1,q0[1]);
	boothsubstep step2(A1,Q1,q0[1],b,A2,Q2,q0[2]);
	boothsubstep step3(A2,Q2,q0[2],b,A3,Q3,q0[3]);
	boothsubstep step4(A3,Q3,q0[3],b,A4,Q4,q0[4]);
	boothsubstep step5(A4,Q4,q0[4],b,A5,Q5,q0[5]);
	boothsubstep step6(A5,Q5,q0[5],b,A6,Q6,q0[6]);
	boothsubstep step7(A6,Q6,q0[6],b,A7,Q7,q0[7]);
	boothsubstep step8(A7,Q7,q0[7],b,c[15:8],c[7:0],qout);
